        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductionCountryCode = table.Column<string>(type: "nchar(2)", fixedLength: true, maxLength: 2, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProductionCountryCode,
                        principalTable: "Countries",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustOrder = table.Column<short>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieCountries", x => new { x.MovieId, x.CountryCode });
                    table.ForeignKey(
                        name: "FK_MovieCountries_Countries_CountryCode",
                        column: x => x.CountryCode,
                        principalTable: "Countries",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingOrder = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieDirectors_People_DirectorId",
                        column: x => x.DirectorId,
                        principalTable: "People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SessionSeats_Bookings_BookingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieActors_MovieId_CustOrder",
                table: "MovieActors",
                columns: new[] { "MovieId", "CustOrder" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MovieCountries_CountryCode",
                table: "MovieCountries",
                column: "CountryCode");

            migrationBuilder.CreateIndex(
                name: "IX_MovieCountries_MovieId_CountryCode",
                table: "MovieCountries",
                columns: new[] { "MovieId", "CountryCode" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieDirectors_MovieId_BillingOrder",
                table: "MovieDirectors",
                columns: new[] { "MovieId", "BillingOrder" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionSeats_BookingId",
                table: "SessionSeats",
                column: "BookingId");
